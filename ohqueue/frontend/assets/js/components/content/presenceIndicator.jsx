...
export class PresenceIndicator extends React.Component {
    ...
    render(){
        let presence = this.props.presence
        ...
        let pendingTickets = this.filterTickets(this.props.tickets, 'pending');
        let assignedTickets = this.filterTickets(this.props.tickets, 'assigned');
